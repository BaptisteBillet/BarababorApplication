...
{
	[System.Serializable]
	public class EYESRow : IGoogle2uRow
	{
		public string _Name;
		public int _Cost;
		public int _Appearance;
		public string _ShownName;
		public EYESRow(string __ID, string __Name, string __Cost, string __Appearance, string __ShownName) 
		{
			_Name = __Name.Trim();
			{
			int res;
	...
	public sealed class EYES : IGoogle2uDB
	{
		public enum rowIds {
			Eyes1
		};
		...
		public System.Collections.Generic.List<EYESRow> Rows = new System.Collections.Generic.List<EYESRow>();

		public static EYES Instance
		{
			get { return NestedEYES.instance; }
		}

		private class NestedEYES
		{
			static NestedEYES() { }
			internal static readonly EYES instance = new EYES();
		}

		private EYES()
		{
			Rows.Add( new EYESRow("Eyes1", "Eyes1", "11", "0", "Eyes1"));
		}
		...
		public EYESRow GetRow(rowIds in_RowID)
		{
			EYESRow ret = null;
			try
			{
		...
		public EYESRow GetRow(string in_RowString)
		{
			EYESRow ret = null;
			try
			{
