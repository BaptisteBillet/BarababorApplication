...
{
	[System.Serializable]
	public class NOSERow : IGoogle2uRow
	{
		public string _Name;
		public int _Cost;
		public int _Appearance;
		public string _ShownName;
		public NOSERow(string __ID, string __Name, string __Cost, string __Appearance, string __ShownName) 
		{
			_Name = __Name.Trim();
			{
			int res;
	...
	public sealed class NOSE : IGoogle2uDB
	{
		public enum rowIds {
		...
		public System.Collections.Generic.List<NOSERow> Rows = new System.Collections.Generic.List<NOSERow>();

		public static NOSE Instance
		{
			get { return NestedNOSE.instance; }
		}

		private class NestedNOSE
		{
			static NestedNOSE() { }
			internal static readonly NOSE instance = new NOSE();
		}
		...
		public NOSERow GetRow(rowIds in_RowID)
		{
			NOSERow ret = null;
			try
			{
		...
		public NOSERow GetRow(string in_RowString)
		{
			NOSERow ret = null;
			try
			{
